...
/**
 * Analytics report options interface
 */
 ...
 */
export async function getSystemAnalytics(options: AnalyticsOptions = {}): Promise<any> {
  const perfEnd = performance.start('analytics-system-report');
  ...
  try {
    ...
    logger.info(`Generated system analytics report in ${perfEnd()}ms`);
 ...
 */
export async function getDocumentAnalytics(documentId: number): Promise<any> {
  const perfEnd = performance.start('analytics-document-report');
  const db = getConnection();
  ...
  try {
    ...
    logger.info(`Generated document analytics report for document ${documentId} in ${perfEnd()}ms`);
    
    return report;
  } catch (error) {
    logger.error(`Error generating document analytics for document ${documentId}:`, error);
    throw error;
  }
}
...
export async function getUserAnalytics(userId: number): Promise<any> {
  const perfEnd = performance.start('analytics-user-report');
  const db = getConnection();
  ...
  try {
    ...
    logger.info(`Generated user analytics report for user ${userId} in ${perfEnd()}ms`);
    
    return report;
  } catch (error) {
    logger.error(`Error generating user analytics for user ${userId}:`, error);
    throw error;
  }
}
 ...
 */
function getDateRangeFromOptions(options: AnalyticsOptions): { startDate: Date, endDate: Date } {
  const now = new Date();
 ...
 * Get document metrics
 */
async function getDocumentMetrics(db, startDate: Date, endDate: Date, options: AnalyticsOptions): Promise<any> {
 ...
 * Get storage metrics
 */
async function getStorageMetrics(db, startDate: Date, endDate: Date, options: AnalyticsOptions): Promise<any> {
  // Total storage usage
  const storageQuery = `
    SELECT 
 ...
 */
async function getUserActivityMetrics(db, startDate: Date, endDate: Date, options: AnalyticsOptions): Promise<any> {
  // User activity metrics
 ...
 * Get search metrics
 */
async function getSearchMetrics(db, startDate: Date, endDate: Date, options: AnalyticsOptions): Promise<any> {
  // Search metrics
  const searchQuery = `
    SELECT 
      COUNT(*) as total_searches,
 ...
 */
async function getApiMetrics(db, startDate: Date, endDate: Date, options: AnalyticsOptions): Promise<any> {
  // Total API requests
  const apiUsageQuery = `
    SELECT 
      COUNT(*) as total_requests,
 ...
 * Get AI usage metrics
 */
async function getAiUsageMetrics(db, startDate: Date, endDate: Date, options: AnalyticsOptions): Promise<any> {
  // Total AI usage
  const aiUsageQuery = `
    SELECT 
      COUNT(*) as total_requests,
 ...
 */
function getTimeGroupingSQL(groupBy: string): string {
